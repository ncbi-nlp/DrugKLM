...
def convert_jsons_to_tsv(input_folder, output_tsv):
    ...
    for file in os.listdir(input_folder):
        if file.endswith(".json"):
            ...
            rows.append({
                ...
                "mechanistic_confidence_level": verdict.get("mechanistic_confidence_level", ""),
                ...
                "mechanistic_confidence_score": verdict.get("mechanistic_confidence_score", 0),
    ...
    rows.sort(
        key=lambda r: (
            int(r["mechanistic_confidence_score"]) if str(r["mechanistic_confidence_score"]).isdigit() else 0,
    ...
    fieldnames = [
        ...
        "mechanistic_confidence_level", "subtype", "risk_level",
        "overall_confidence_score", "subtype_confidence_score", "mechanistic_confidence_score",
