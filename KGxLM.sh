...
# KGxLM.sh
#
# KGxLM4Drug: Disease-specific Drug Ranking & Mechanistic Evidence Pipeline
#
# Usage:
#   ./KGxLM.sh "Disease Name"
#
# Example:
#   ./KGxLM.sh "Acute Myeloid Leukemia"
#
# This script executes the full KGxLM pipeline:
...
############################
Disease=$1
echo "Running KGxLM pipeline for disease: ${Disease}"
...
###############################################################################
python 1.KGxLM.disease2drug.candidate.py \
...
###############################################################################
python 2.KGxLM.disease2gene.candidate.py \
  --json_input input/${Disease}.json \
...
echo "KGxLM pipeline completed for disease: ${Disease}"
###############################################################################
