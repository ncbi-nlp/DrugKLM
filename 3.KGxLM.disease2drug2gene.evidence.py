...
# -----------------------
entity_embedding_path = Path("../KGxLM4Drug/HAKE_model/PrimeKGwE/entity_embedding.npy")
relation_embedding_path = Path("../KGxLM4Drug/HAKE_model/PrimeKGwE/relation_embedding.npy")
relation_dict_path = Path("../KGxLM4Drug/data/PrimeKG/relations.dict")
entity_dict = "../KGxLM4Drug/data/PrimeKG/entities.dict"
...
with open("../KGxLM4Drug/pickle/PrimeKG/NER_ID_dict_cap_final.pickle", "rb") as f:
    name_to_idx = pickle.load(f)

with open("../KGxLM4Drug/pickle/PrimeKG/biokdeid_type_map.pickle", "rb") as f:
    biokdeid_type_map = pickle.load(f)

with open("../KGxLM4Drug/pickle/PrimeKG/DBRelations.no5.pickle", "rb") as f:
...
def main():
    ...
    id_to_official = load_name_map("../KGxLM4Drug/pickle/PrimeKG/NER_ID_dict_cap_final.pickle")
...
python 3.KGxLM.disease2drug2gene.evidence.py \
  ...
  --ctd_tsv ../KGxLM4Drug/DB/DrugGeneRelationEvdience.CTD.tsv \
  --pubtator_tsv ../KGxLM4Drug/DB/DrugGeneRelationEvdience.PubTator3.tsv \
  --dgidb_tsv ../KGxLM4Drug/DB/DrugGeneRelationEvdience.dgidb.drug2genes.tsv \
  --lincs_tsv ../KGxLM4Drug/DB/DrugGeneRelationEvdience.LINCS.cp_coeff.tsv \
