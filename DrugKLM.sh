...
# DrugKLM.sh
#
# DrugKLM4Drug: Disease-specific Drug Ranking & Mechanistic Evidence Pipeline
#
# Usage:
#   ./DrugKLM.sh "Disease Name"
#
# Example:
#   ./DrugKLM.sh "Acute Myeloid Leukemia"
#
# This script executes the full DrugKLM pipeline:
